...
function addWhitelistAddIcon(username, lastChild) {
    ...
    element.src = window.chrome.runtime.getURL("images/acc_add.png");
...
function addWhitelistRemoveIcon(username, lastChild) {
    const element = document.createElement('img');
    element.className = lastChild.className;
    element.src = window.chrome.runtime.getURL("images/acc_remove.png");
...
const getting = window.chrome.storage.sync.get('whitelist');
